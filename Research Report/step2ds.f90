...
!    !$omp end single
!    !$omp end parallel
!    write(*,*) 'Number of Thread = ', nthreads
...
time5 = omp_get_wtime() - time0
write(*,*) 'x-sweeps spends ', time2,' seconds'
write(*,*) 'y-sweeps spends ', time4,' seconds'
write(*,*) 'the subroutine spends ', time5,' seconds'
